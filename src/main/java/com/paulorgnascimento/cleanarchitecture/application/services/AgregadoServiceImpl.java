...
import com.paulorgnascimento.cleanarchitecture.domain.event.EventoDominioEvent;
...
public class AgregadoServiceImpl implements AgregadoService {
    ...
    public void criarAgregado(AgregadoInDto agregadoInDto) {
        ...
        eventPublisher.publishEvent(new EventoDominioEvent(this, agregadoMapping.getId()));
    }
